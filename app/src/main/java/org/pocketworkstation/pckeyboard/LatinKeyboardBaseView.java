...
public class LatinKeyboardBaseView extends View implements PointerTracker.UIProxy {
    ...
    public LatinKeyboardBaseView(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // NOTE: this is an if/else chain rather than a switch because AGP 9's
            // non-final app R class (android.enableAppCompileTimeRClass=true by
            // default) means R.styleable.* fields are no longer compile-time
            // constants, which a switch's case labels require.
